...
def get_all_columns(project, *_):
    ...
    result['columns'] += [
        ...
        {
            'id': 'annotator_time',
            'title': 'Annotator Time',
            'type': 'Number',
            'target': 'tasks',
            'help': 'Time taken by the annotator',
            'visibility_defaults': {'explore': True, 'labeling': False},
            'project_defined': False,
        },
        {
            ...
            'type': 'Number',
            'target': 'tasks',
            'help': 'Time taken by the reviewer',
            'visibility_defaults': {'explore': True, 'labeling': False},
            'project_defined': False,
        },
        {
            ...
            'type': 'Number',
            'target': 'tasks',
            'help': 'Number of times this task was rejected',
            'visibility_defaults': {'explore': True, 'labeling': False},
            'project_defined': False,
        },
        {
            ...
            'type': 'String',
            'target': 'tasks',
            'help': 'Current assignment state (pending_annotation, pending_review, completed, rejected)',
            'visibility_defaults': {'explore': True, 'labeling': False},
            'project_defined': False,
        },
        {
            'id': 'assignment.assigned_at',
            'title': 'Assigned At',
            'type': 'Datetime',
            'target': 'tasks',
            'help': 'When the task was assigned',
            'visibility_defaults': {'explore': True, 'labeling': False},
            'project_defined': False,
        },
        {
            'id': 'assignment.started_at',
            'title': 'Started At',
            'type': 'Datetime',
            'target': 'tasks',
            'help': 'When the annotator first opened the task',
            'visibility_defaults': {'explore': True, 'labeling': False},
            'project_defined': False,
        },
        {
            'id': 'assignment.working_seconds',
            'title': 'Working Time (s)',
            'type': 'Number',
            'target': 'tasks',
            'help': 'Live elapsed seconds since the annotator started; frozen on completion',
            'visibility_defaults': {'explore': True, 'labeling': False},
            'project_defined': False,
        },
        {
